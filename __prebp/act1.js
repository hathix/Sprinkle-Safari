...
acts.push(new Act(1,function(levelNum){
	...
	case 1:
		...
		startDialogues = [
			dCharacter("Yawn. Let's see what the newspaper has to say... sure hope the Pastries won yesterday..."),
			dEnemy("Squirrel","Hey you! Hand over all your donuts before you get hurt!"),
			dCharacter("Er, what? Can you say that again?"),
			dEnemy("Squirrel","I said, GIVE. ME. YOUR. DONUTS."),
			dCharacter("I'm fresh out of donuts, actually, I'll need to go get some more. So if you'd hand me the newspaper..."),
			dEnemy("Squirrel","Ha! Right. They didn't put us goons all over the borough just to hand over the newspaper. Guess I'll just have to beat you up to get those donuts, then!"),
			dCharacter("Geez. Click on me to activate me, then move me around with the arrows. I'll attack someone if you direct me in their direction."),
			dEnemy("Squirrel","Come on, you gonna fight or not? Come on, attack me!"),
			dCharacter("All right. Once this guy is out of the way, move me to the flag to finish the level.")
			];
		endDialogues = [
		...
		newAlly = new Ally('Elephant',0,0,1,MAIN_CHAR_NAME);
		break;
	case 2:
		...
		startDialogues = [
			dCharacter('Hi, Chase! What\'s up?'),
			dNeutral('Chase','Dog','A lot, actually. These goons attacked me and stole all my donuts. I\'ve been trying to fight them off but there are too many of them.'),
			dCharacter('Ouch, that\'s tough. Say, I\'m heading for Bagelsburg, and I guess I\'ll have to fight some of these goons on the way. Would you like to come along?'),
			dNeutral('Chase','Dog','And help you beat up those thugs? Of course! Count me in!'),
			dAlly('Chase','Dog','Click on a teammate to activate them so you can move and attack with them.'),
			dCharacter('Keep an eye on your health, Chase, I don\'t want you getting hurt. Hover over a teammate to see their stats and HP.'),
			dEnemy('Squirrel','Hey, the newspaper guy and his friend are here! Quick, everyone protect the hearts! We can\'t let them heal themselves!')
		];
		endDialogues = [
	...
	case 4:
		...
		startDialogues = [
			...
			dEnemy("Dog","Once again, Petey ol' boy, go fish.","Mark"),
	...
	case 8:
	 ...
	 case 9:
		...
		obstacles = [new Obstacle("water",10,0),new Obstacle("water",12,0),new Obstacle("water",11,0),new Obstacle("water",11,1),new Obstacle("water",12,1),new Obstacle("water",13,1),new Obstacle("water",13,0),new Obstacle("water",14,0),new Obstacle("water",14,1),new Obstacle("water",14,2),new Obstacle("water",13,2),new Obstacle("water",12,2),new Obstacle("water",12,3),new Obstacle("water",13,3),new Obstacle("water",14,3),new Obstacle("water",13,4),new Obstacle("water",14,4),new Obstacle("water",14,5),new Obstacle("water",14,6),new Obstacle("water",14,7),new Obstacle("water",14,8),new Obstacle("water",14,9),new Obstacle("water",14,10),new Obstacle("water",14,11),new Obstacle("water",14,12),new Obstacle("water",14,14),new Obstacle("water",14,13),new Obstacle("water",13,12),new Obstacle("water",13,13),new Obstacle("water",13,14),new Obstacle("water",12,14),new Obstacle("water",11,14),new Obstacle("water",11,13),new Obstacle("water",11,12),new Obstacle("water",12,12),new Obstacle("water",12,13),new Obstacle("water",10,9),new Obstacle("water",11,9),new Obstacle("water",12,9),new Obstacle("water",12,11),new Obstacle("water",12,10),new Obstacle("water",11,10),new Obstacle("water",10,10),new Obstacle("water",10,11),new Obstacle("water",11,11),new Obstacle("water",10,12),
			...
			Obstacle("water",7,12),new Obstacle("water",7,13),new Obstacle("water",7,14),new Steppable("flag",9,14),new Steppable("half-heart",1,11),new Steppable("half-heart",5,11),new Steppable("half-heart",13,11),new Steppable("full-heart",5,0),];
		enemies = [
