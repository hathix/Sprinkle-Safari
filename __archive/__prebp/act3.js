...
enemies = [new Enemy("Pterodactyl",4,4,5),new Enemy("Pterodactyl",6,4,5),new Enemy("Plesiosaur",6,9,5),new Enemy("Plesiosaur",11,3,5),];	
		...
		startDialogues = [
			...
			dEnemy("Plesiosaur","Guys! Guys! Someone's here! Get 'em!"),
			dEnemy("Triceratops","Hey, birdbrains! What are you doing on that island?"),
			dEnemy("Pterodactyl","What? We can fly, you know."),
			dEnemy("Triceratops","Yeah, sure, but you're not going to find the Teasure of the Croissant like that."),
			dEnemy("Pterodactyl","Yeah, well you aren't either by standing there lecturing us."),
			dEnemy("Pterodactyl","Need some ice with that?","Pterodactyl 2")
		];
		endDialogues = [
...
enemies = [new Enemy("Ghost",7,4,5),new Enemy("Ghost",7,3,5),new Enemy("Ghost",7,10,5),new Enemy("Ghost",7,11,5),new Enemy("Bat",2,6,5),new Enemy("Bat",12,4,5),new Enemy("Bat",10,13,5),new Enemy("Bat",4,3,5),new Enemy("Triceratops",7,7,6),];
	...
	case 7:
		...
		startDialogues = [
			...
			dEnemy("Triceratops","Can I PLEASE kill him? Please? I've put up with all his terrible memes, but this... I seriously feel like I'm going to blow up!"),
	...
	case 8:
		...
		startDialogues = [
			...
			dEnemy("Plesiosaur","Sigh. GET THEM!")
		];
		endDialogues = [
