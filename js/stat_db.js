...
var STAT_DB = {
		...
		*/	
		...
		Elephant:	new AnimalStats(24,2.9,17,1.7,32,3.3,Abilities.Friendly),	//53-34-65
		...
		Plesiosaur:	new AnimalStats(20,2.6,13,1.4,36,4.2,Abilities.Calm),		//46-27-78
	   ...
	   Brontosaurus:new AnimalStats(21,2.3,17,1.4,28,3.1,Abilities.Sniper),		//44-31-59
		...
		Hippo:		new AnimalStats(24,2.7,17,1.6,25,3.3,Abilities.Soothe),		//51-33-58
		...
		Monkey:		new AnimalStats(27,2.8,13,1.4,23,3.2,Abilities.Bananarama),	//55-27-55
		
		//5.
		Llama:		new AnimalStats(29,2.0,21,1.0,34,3.0,Abilities.Gambler),	//49-31-64
		Peacock:	new AnimalStats(21,3.0,13,2.0,29,2.9,Abilities.Showy),		//51-33-58
		Panda:		new AnimalStats(23,2.1,13,1.4,26,2.9,Abilities.Bamboomerang)//44-27-55
	   ,Ostrich:	new AnimalStats(19,2.2,24,1.5,27,3.0,Abilities.Kamikaze),	//41-39-57	
		...
		Alligator:	new AnimalStats(26,2.7,11,1.4,19,3.8,Abilities.Shockwave),	//53-25-57
		Lion:		new AnimalStats(25,2.5,16,1.2,29,3.4,Abilities.Pride),		//50-28-63
		Tiger:		new AnimalStats(26,2.9,16,1.5,19,2.5,Abilities.Immobilize),	//55-31-44
		Kangaroo:	new AnimalStats(20,2.5,17,1.9,24,3.4,Abilities.Protective),	//45-36-58
		Turtle:		new AnimalStats(12,2.0,18,2.8,16,3.8,Abilities.Lockdown),	//32-46-54
		...
		Monkey_Boss:		new AnimalStats(60,0,25,0,75,0,Abilities.Bananarama),//60-25-75
		Llama_Boss:			new AnimalStats(55,0,40,0,100,0,Abilities.Refresh),	//55-40-100
		Elephant_Boss:		new AnimalStats(70,0,30,0,150,0,Abilities.Clutch),	//70-30-150
		
		/** This is just so Animal() will have a temporary statDB. Also a template. */
