...
acts.push(new Act(2,function(levelNum){
	...
	case 5:
		...
		startDialogues = [
			...
			dEnemy("Duck","Not STINKY, S.T.I.N.K.Y! As in, the Supremely Talented and Incredibly Nifty King of the Yellers? Don't you know who he is?"),
			dCharacter("Not really, sorry."),
	...
	case 6:
		...
		newAlly = new Ally("Goat",2,5,3,"Trent");
		startDialogues = [
	...
	case 9:
		...
		obstacles = [new Obstacle("tree",11,0),new Obstacle("tree",11,2),new Obstacle("tree",11,3),new Obstacle("tree",12,4),new Obstacle("tree",13,4),new Obstacle("tree",14,4),new Obstacle("barrel",7,12),new Obstacle("barrel",6,12),new Obstacle("barrel",6,13),new Obstacle("barrel",7,14),new Obstacle("barrel",10,12),new Obstacle("barrel",9,11),new Obstacle("barrel",9,13),new Obstacle("barrel",10,14),new Obstacle("barrel",7,8),new Obstacle("barrel",7,4),new Obstacle("barrel",4,3),new Obstacle("hydrant",13,1),new Obstacle("hydrant",5,6),new Obstacle("hydrant",8,9),
			...
			new Steppable("secret-entrance",13,2)];
		enemies = [
		...
		break;
	case SECRET_STAGE:
		grid = 'wwwwwwwwwwwwwww wwwwwwwwwwwwwww wwwwwwwwwwwwwww wwwwwwwwwwwwwww wwwwwwwwwwwwwww wwwwwtttttwwwww wwwwwtttttwwwww wwwwwtttttwwwww wwwwwtttttwwwww wwwwwtttttwwwww wwwwwwwwwwwwwww wwwwwwwwwwwwwww wwwwwwwwwwwwwww wwwwwwwwwwwwwww wwwwwwwwwwwwwww';
		obstacles = [new Obstacle("chair",3,11),new Obstacle("chair",2,12),new Obstacle("chair",4,12),new Obstacle("chair",2,13),new Obstacle("chair",4,13),new Obstacle("chair",11,11),new Obstacle("chair",12,12),new Obstacle("chair",12,13),new Obstacle("chair",10,12),new Obstacle("chair",10,13),new Obstacle("chair",3,3),new Obstacle("chair",4,2),new Obstacle("chair",4,1),new Obstacle("chair",2,2),new Obstacle("chair",2,1),new Obstacle("chair",11,3),new Obstacle("chair",10,2),new Obstacle("chair",10,1),new Obstacle("chair",12,2),new Obstacle("chair",12,1),new Obstacle("chair",7,3),new Obstacle("chair",7,11),new Obstacle("chair",3,7),new Obstacle("chair",11,7),new Obstacle("barrel",1,9),new Obstacle("barrel",5,3),new Obstacle("barrel",5,13),new Obstacle("barrel",14,7),new Obstacle("barrel",13,3),new Obstacle("barrel",10,9),new Obstacle("barrel",0,14),new Obstacle("barrel",1,6),new Steppable("half-heart",0,7),new Steppable("half-heart",14,1),new Steppable("flag",7,7),];
		enemies = [new Enemy("Lion",3,7,4,0.5),new Enemy("Lion",11,7,4,0.5),new Enemy("Mouse",6,7,4,0.2),new Enemy("Pig",11,13,4,0.2),new Enemy("Elephant",7,1,4,0.2),];
		allyPositions = [[1,12],[14,10],[4,4],[12,10],[6,11]];
		startDialogues = [
			dCharacter("Wh-where am I?"),
			dEnemy("Mouse","Felicitations, brother! You're at one of the totally rad parties of Omega Delta Omega Rho, also knows as ΩΔΩP or rather ODOR.", "Brother Martin"),
			dCharacter("So... you're a bunch of drunken frat boys?"),
			dEnemy("Lion","I wouldn't say that, brother. We are drunken frat <em>brothers.</em>", "Brother Luke"),
			dEnemy("Mouse","My comrade is right! While you're here, brother, would you care to consume some comestibles?", "Brother Martin"),
			dCharacter("No offense, but instead of partying I should probably be teleporting to East Sprinklestan."),
			dEnemy("Mouse","WHAT? And waive the opportunity to partake in some merriment on the dance floor?", "Brother Martin"),
			dEnemy("Pig","Ach, schuddup and FIGHT already, Bruder...", "Brother Otto")
		];
		break;
	}
