...
function GridObject(type,pictureFolder,div,x,y){
	this.type = orDefault(type, "");
	this.pictureFolder = orDefault(pictureFolder, "");
	this.div = orDefault(div, makeDiv());
	this.flags = new Flags();
	this.x = orDefault(x, 0);
	this.y = orDefault(y, 0);	
    ...
    this.tile = null; //tile this is contained in
}
...
GridObject.prototype.putInTile = function(){
    this.tile = currentLevel.getTile(new Coords(this.x, this.y));
    this.tile.addContents(this);
}
...
/**
 * Returns a Coords object containing the gridobject's x and y 
 */
GridObject.prototype.getCoords = function(){
